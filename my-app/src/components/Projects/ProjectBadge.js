                            ...
                            <Paper className={classes.paper}>
                                <Grid container direction="row" alignItems="center">
                                    ...
                                    <Grid item style={{}} xs={10}>
                                        <Badge color="primary" 
                                            badgeContent={<Tooltip title="Ongoing"><div></div></Tooltip>}
                                            variant="dot"
                                            anchorOrigin={{ vertical: 'top', horizontal: 'right'}}
                                        >
                                        <Typography variant="h6" style={{fontWeight: "bold", marginBlockStart: "-7px", marginInlineEnd: "5px"}} gutterBottom>StudentxCEOs 10th Grand Summit</Typography>
                                        </Badge>
                                ...
                                <Grid container direction="row" alignItems="center">
                                    ...
                                    <Grid item style={{}} xs={10}>
                                        <Badge color="primary" 
                                            ...
                                            anchorOrigin={{ vertical: 'top', horizontal: 'right'}}
                                        >
                                            <Typography variant="h6" style={{fontWeight: "bold", marginBlockStart: "-7px", marginInlineEnd: "5px"}} gutterBottom>Web Search Engine</Typography>
                                        </Badge>
                                ...
                                <Grid container direction="row" alignItems="center">
                                    ...
                                    <Grid item style={{}} xs={10}>
                                        <Badge color="primary" 
                                            ...
                                            anchorOrigin={{ vertical: 'top', horizontal: 'right'}}
                                        >
                                            <Typography variant="h6" style={{fontWeight: "bold", marginBlockStart: "-7px", marginInlineEnd: "5px"}} gutterBottom>Web-Movies-and-Games-Catalog</Typography>
                                        </Badge>
                            ...
                            <Grid container direction="row" alignItems="center">
                                ...
                                <Grid item style={{}} xs={10}>
                                    <Badge color="error" 
                                        ...
                                        anchorOrigin={{ vertical: 'top', horizontal: 'right'}}
                                    >
                                        <Typography variant="h6" style={{fontWeight: "bold", marginBlockStart: "-7px", marginInlineEnd: "5px"}} gutterBottom>Arkavidia 7.0</Typography>
                                    </Badge>
                            ...
                            <Grid container direction="row" alignItems="center">
                                ...
                                <Grid item style={{}} xs={10}>
                                    <Badge color="primary" 
                                        ...
                                        anchorOrigin={{ vertical: 'top', horizontal: 'right'}}
                                    >
                                    <Typography variant="h6" style={{fontWeight: "bold", marginBlockStart: "-7px", marginInlineEnd: "5px"}} gutterBottom>Indonesia-COVID19-Cases-TrackerApp</Typography>
                                    </Badge>
